    ...
    <ul>
        <li class="tui-dropdown">
            ...
            <span on:click={handleToggleBackend}>
              {$rpcStore.useBackend ? 'Use Local' : 'Use Remote'}
                    ...
                    <li>
            <span on:click={handleExportData}>
              Export Data
            </span>
                    </li>
                    <li>
            <span on:click={handleImportData}>
              Import Data
            </span>
                    </li>
                    <li>
            <span on:click={handleClearData}>
              Clear Local
            </span>
                    </li>
                </ul>
        ...
        <li class="tui-dropdown">
            ...
            <div class="tui-dropdown-content">
                <ul>
                    <li>
            <span class="tui-menu-item" class:tui-menu-active={$rpcStore.timeRange === '15m'}
                  on:click={() => handleTimeRangeSelect('15m')}>
              Last 15 min
            </span>
                    </li>
                    <li>
            <span class="tui-menu-item" class:tui-menu-active={$rpcStore.timeRange === '1h'}
                  on:click={() => handleTimeRangeSelect('1h')}>
              Last hour
            </span>
                    </li>
                    <li>
            <span class="tui-menu-item" class:tui-menu-active={$rpcStore.timeRange === '3h'}
                  on:click={() => handleTimeRangeSelect('3h')}>
              Last 3 hours
            </span>
                    </li>
                    <li>
            <span class="tui-menu-item" class:tui-menu-active={$rpcStore.timeRange === '12h'}
                  on:click={() => handleTimeRangeSelect('12h')}>
              Last 12 hours
            </span>
                    </li>
                    <li>
            <span class="tui-menu-item" class:tui-menu-active={$rpcStore.timeRange === '24h'}
            ...
            <div class="tui-dropdown-content">
                <ul>
                    {#each rpcMethods as method}
                        <li>
              <span class="tui-menu-item" class:tui-menu-active={$rpcStore.selectedMethod === method.id}
        ...
        <span class="tui-datetime" data-format="h:m:s a">{$rpcStore.currentTime.toLocaleTimeString()}</span>
    </ul>
</nav>
